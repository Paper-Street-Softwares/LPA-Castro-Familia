...
function HeroTemplateNovo({
  ...
  return (
    ...
    >
      <section className="relative w-full pt-[90px] phone3:pt-[110px] tablet1:pt-[114px] tablet2:pt-[127px] desktop1:pt-[135px] desktop2:pt-[155px] pb-[64px] desktop1:pb-[96px] flex items-center justify-center overflow-hidden font-mainFont">
